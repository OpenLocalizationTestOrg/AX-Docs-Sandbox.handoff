...
# ms.tgt_pltfrm: 
ms.custom: 14741
ms.assetid: daf5ee52-17ab-415c-b5e9-12a3689af99f
# ms.region: 
# ms.industry: 
ms.author: jasongre
...
## Wireframe
![patternNSLD]][](media/NestedSimpleListAndDetails1.png

## Pattern changes for Dynamics AX
Here are the main changes to this pattern since Microsoft Dynamics AX 2012:

-   This pattern is new for Microsoft Dynamics AX.  Any pattern changes to the SL+D pattern can be found in the [Simple List and Details](http://ax.help.dynamics.com/en/wiki/simple-list-and-details-form-pattern/)pattern document.
