...
# <a name="set-up-security-for-the-cost-accounting-analysis-power-bi-content"></a>Set up security for the Cost accounting analysis Power BI content
...
## <a name="updating-security"></a>Updating security
...
## <a name="disabling-security"></a>Disabling security
