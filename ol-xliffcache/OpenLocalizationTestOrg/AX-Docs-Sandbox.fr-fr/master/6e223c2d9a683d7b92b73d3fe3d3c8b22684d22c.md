...
# <a name="standard-cost-conversion-overview"></a>Standard cost conversion overview
...
## <a name="1-define-a-standard-cost-conversion-record-and-the-associated-costing-version"></a>1. Define a standard cost conversion record and the associated costing version
...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Review and change the new costing version for the conversion record
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Identify the items to convert to standard cost
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Enter or calculate the pending standard cost for each item that is being converted
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Check and resolve any issues for the items that are being converted
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. Change the status of the conversion record to Ready
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Back up the database before conversion
The backup lets you restore the database if errors are encountered during the conversion.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. Perform the conversion when the conversion record has a Ready status
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. Validate and reconcile the inventory values for the converted items
