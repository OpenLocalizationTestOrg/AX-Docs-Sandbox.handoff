...
## <a name="pricing-terms-for-sales-agreements"></a>Pricing terms for sales agreements
...
## <a name="policies-for-sales-agreements"></a>Policies for sales agreements
...
## <a name="fulfillment-calculations-for-sales-agreements"></a>Fulfillment calculations for sales agreements
...
## <a name="confirmations-and-version-history-for-sales-agreements"></a>Confirmations and version history for sales agreements
...
## <a name="applying-sales-agreements-during-the-ordering-process"></a>Applying sales agreements during the ordering process
...
## <a name="modifying-sales-orders-that-are-linked-to-sales-agreements"></a>Modifying sales orders that are linked to sales agreements
...
## <a name="returning-an-item-that-was-ordered-from-a-sales-agreement"></a>Returning an item that was ordered from a sales agreement
...
## <a name="automatic-search-for-sales-agreements"></a>Automatic search for sales agreements
