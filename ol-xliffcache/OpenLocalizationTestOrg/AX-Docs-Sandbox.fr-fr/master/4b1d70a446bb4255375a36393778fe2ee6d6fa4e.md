...
# <a name="system-defined-and-user-defined-table-constraints"></a>System-defined and user-defined table constraints
...
## <a name="user-defined-table-constraints"></a>User-defined table constraints
...
## <a name="system-defined-table-constraints"></a>System-defined table constraints
