...
## <a name="example-1-route-a-purchase-requisition-as-a-single-document-for-review"></a>Example 1: Route a purchase requisition as a single document for review
...
## <a name="example-2-route-the-individual-purchase-requisition-lines-for-review"></a>Example 2: Route the individual purchase requisition lines for review
...
## <a name="configuring-a-workflow-for-purchase-requisitions"></a>Configuring a workflow for purchase requisitions
...
### <a name="purchase-requisition-expenditure-reviewers"></a>Purchase requisition expenditure reviewers
