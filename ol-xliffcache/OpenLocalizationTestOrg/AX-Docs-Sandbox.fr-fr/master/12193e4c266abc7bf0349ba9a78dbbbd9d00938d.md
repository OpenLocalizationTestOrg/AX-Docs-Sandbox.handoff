...
# <a name="time-and-attendance-registration"></a>Time and attendance registration
...
## <a name="time-registrations-workers"></a>Time registrations workers
...
## <a name="adding-clockout-registrations"></a>Adding clockout registrations
...
## <a name="calculating-registrations"></a>Calculating registrations
...
## <a name="approving-registrations"></a>Approving registrations
...
## <a name="approving-registrations-using-workflow"></a>Approving registrations using workflow
...
## <a name="transferring-approved-registrations"></a>Transferring approved registrations
...
## <a name="reversing-transferred-registrations"></a>Reversing transferred registrations
...
## <a name="registrations-in-electronic-timecards"></a>Registrations in electronic timecards
