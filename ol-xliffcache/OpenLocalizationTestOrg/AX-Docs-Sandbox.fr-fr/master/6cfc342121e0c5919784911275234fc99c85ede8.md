...
# <a name="settle-a-partial-vendor-payment-and-the-final-payment-in-full-before-the-discount-date"></a>Settle a partial vendor payment and the final payment in full before the discount date
...
## <a name="vendor-invoice-on-june-25"></a>Vendor invoice on June 25
...
## <a name="partial-payment-on-july-1-by-using-the-settle-transactions-page"></a>Partial payment on July 1 by using the Settle transactions page
...
## <a name="remaining-amount-paid-on-july-8"></a>Remaining amount paid on July 8
