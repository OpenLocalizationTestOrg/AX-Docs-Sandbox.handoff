...
# ms.tgt_pltfrm: 
ms.custom: 92013
ms.assetid: 0ed4227d-da4e-4fba-aabc-c728cf720da5
# ms.region: 
# ms.industry: 
ms.author: annbe
...
[Create and use localizable labels in the client](http://ax.help.dynamics.com/en/wiki/create-and-use-localizable-labels-in-the-client/)

[View and export field descriptions](http://ax.help.dynamics.com/en/wiki/how-to-view-and-export-field-descriptions/)
