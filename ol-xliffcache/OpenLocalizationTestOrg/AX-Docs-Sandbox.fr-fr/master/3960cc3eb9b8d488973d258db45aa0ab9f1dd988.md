...
# <a name="search-for-products-and-product-variants-during-order-entry"></a>Search for products and product variants during order entry
...
## <a name="configure-the-product-search"></a>Configure the product search
...
### <a name="step-1-include-all-the-relevant-product-and-product-variant-identifiers-and-dimensions-in-the-search-criteria"></a>Step 1: Include all the relevant product and product variant identifiers and dimensions in the search criteria
...
### <a name="step-2-populate-the-database-table-that-is-used-for-product-search"></a>Step 2: Populate the database table that is used for product search
