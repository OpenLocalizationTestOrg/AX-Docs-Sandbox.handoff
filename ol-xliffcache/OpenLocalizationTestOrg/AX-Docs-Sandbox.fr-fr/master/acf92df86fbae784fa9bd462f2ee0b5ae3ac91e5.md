...
## <a name="can-the-year-end-process-be-run-more-than-one-time-on-the-same-data"></a>Can the year-end process be run more than one time on the same data?
...
## <a name="how-do-i-set-up-funds-for-year-end-processing"></a>How do I set up funds for year-end processing?
...
## <a name="how-do-i-set-up-main-accounts-for-year-end-processing"></a>How do I set up main accounts for year-end processing?
