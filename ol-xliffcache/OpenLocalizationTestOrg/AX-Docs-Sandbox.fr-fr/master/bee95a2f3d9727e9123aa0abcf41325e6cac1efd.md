...
# <a name="set-up-vendor-accounts"></a>Set up vendor accounts
...
## <a name="vendor-account-numbers"></a>Vendor account numbers
...
## <a name="vendor-organizations-and-individual-vendors"></a>Vendor organizations and individual vendors
...
## <a name="vendor-contacts"></a>Vendor contacts
...
## <a name="vendors-in-different-legal-entities"></a>Vendors in different legal entities
...
## <a name="putting-a-vendor-on-hold"></a>Putting a vendor on hold
...
## <a name="vendor-invoice-account"></a>Vendor invoice account
...
## <a name="vendor-bank-accounts"></a>Vendor bank accounts
