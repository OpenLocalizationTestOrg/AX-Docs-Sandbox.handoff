...
# <a name="set-up-and-process-recurring-invoices"></a>Set up and process recurring invoices
...
<a name="create-a-recurring-free-text-invoice-template"></a>Create a recurring free text invoice template
---------------------------------------------
...
## <a name="assign-a-free-text-invoice-template-to-a-customer-and-enter-recurrence-details"></a>Assign a free text invoice template to a customer and enter recurrence details
...
## <a name="generate-the-recurring-invoices"></a>Generate the recurring invoices
