...
# <a name="transportation-management-engines"></a>Transportation management engines
...
## <a name="what-engines-are-available"></a>What engines are available?
...
<a name="what-engines-must-be-configured-to-rate-a-shipment"></a>What engines must be configured to rate a shipment?
---------------------------------------------------
...
## <a name="whats-required-to-initialize-a-transportation-management-engine"></a>What’s required to initialize a transportation management engine?
...
<a name="how-is-metadata-used-in-transportation-management-engines"></a>How is metadata used in transportation management engines?
----------------------------------------------------------
...
## <a name="what-can-be-used-as-search-data-in-rate-calculations"></a>What can be used as search data in rate calculations?
...
## <a name="do-all-engine-configurations-require-metadata"></a>Do all engine configurations require metadata?
...
## <a name="how-do-i-configure-metadata-for-a-transportation-management-engine"></a>How do I configure metadata for a transportation management engine?
