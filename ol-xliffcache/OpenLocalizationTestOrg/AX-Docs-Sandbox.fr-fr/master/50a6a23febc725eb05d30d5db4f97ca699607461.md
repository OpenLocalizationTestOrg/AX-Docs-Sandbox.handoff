...
## <a name="prepare-to-run-the-year-end-close"></a>Prepare to run the year-end close
...
## <a name="define-year-end-close-templates"></a>Define year-end close templates
...
## <a name="run-the-year-end-close-process"></a>Run the year-end close process
