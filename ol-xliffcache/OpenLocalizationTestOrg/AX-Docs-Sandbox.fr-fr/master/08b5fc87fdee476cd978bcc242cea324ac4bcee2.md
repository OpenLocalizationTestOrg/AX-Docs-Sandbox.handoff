...
# <a name="settle-a-partial-customer-payment-and-the-final-payment-in-full-before-the-discount-date"></a>Settle a partial customer payment and the final payment in full before the discount date
...
## <a name="partial-payment-by-using-the-enter-customer-payments-page"></a>Partial payment by using the Enter customer payments page
...
## <a name="partial-payment-by-using-the-journal-lines"></a>Partial payment by using the journal lines
...
## <a name="payment-for-the-remaining-amount"></a>Payment for the remaining amount
