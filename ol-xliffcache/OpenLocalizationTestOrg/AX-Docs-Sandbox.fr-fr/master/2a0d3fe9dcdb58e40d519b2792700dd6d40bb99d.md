...
# <a name="weighted-average-date"></a>Weighted average date
...
## <a name="weighted-average-date-direct-settlement-when-the-include-physical-value-option-isnt-used"></a>Weighted average date direct settlement when the Include physical value option isn't used
...
## <a name="weighted-average-date-summarized-settlement-when-the-include-physical-value-option-isnt-used"></a>Weighted average date summarized settlement when the Include physical value option isn't used
...
## <a name="weighted-average-date-direct-settlement-when-the-include-physical-value-option-is-used"></a>Weighted average date direct settlement when the Include physical value option is used
...
## <a name="weighted-average-date-summarized-settlement-when-the-include-physical-value-option-is-used"></a>Weighted average date summarized settlement when the Include physical value option is used
...
## <a name="weighted-average-date-when-marking-is-used"></a>Weighted average date when marking is used
