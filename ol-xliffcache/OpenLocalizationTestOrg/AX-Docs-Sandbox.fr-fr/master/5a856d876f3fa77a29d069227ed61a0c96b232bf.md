...
# ms.tgt_pltfrm: 
ms.custom: 222324
ms.assetid: 4639c6be-f6a3-4144-b0f0-0cd229382630
ms.region: USA
# ms.industry: 
ms.author: rschloma
...
<li>Before you can generate a positive pay file for payroll, you must set up positive pay. For more information, see <a href="https://ax.help.dynamics.com/en/wiki/set-up-and-generate-positive-pay-files/">Set up and generate positive pay</a>.</li>
...
Use this procedure to create a payment journal for multiple pay statements at the same time. Before you generate pay statements, you must generate and release earnings. For more information, see [Generate earnings](http://ax.help.dynamics.com/en/wiki/generate-earnings/). To submit pay statements for multiple workers at the same time, follow these steps.

1.  Generate pay statements, so that earnings, benefits, and taxes are calculated. For more information, see [Work with pay statements](http://ax.help.dynamics.com/en/wiki/work-with-pay-statements/). **Tip:** Before you generate pay statements, we recommend that you view the **Pay statements to recalculate** list page to verify that no pay statements must be recalculated. For more information, see “Modify pay statements” in [Work with pay statements](http://ax.help.dynamics.com/en/wiki/work-with-pay-statements/).
...
1.  Generate pay statements, so that earnings, benefits, and taxes are calculated. For more information, see [Work with pay statements](http://ax.help.dynamics.com/en/wiki/work-with-pay-statements/).
