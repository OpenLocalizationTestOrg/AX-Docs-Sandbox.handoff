...
# ms.tgt_pltfrm: 
ms.custom: 19701
ms.assetid: 49a538ce-a9be-4942-9630-4f769d317dcd
# ms.region: 
...
The following sections in this topic describe the budgeting features that are available for the public sector.  Before you read this topic, you should also read [Budgeting in the public sector](http://ax.help.dynamics.com/en/wiki/budgeting-in-the-public-sector/).
