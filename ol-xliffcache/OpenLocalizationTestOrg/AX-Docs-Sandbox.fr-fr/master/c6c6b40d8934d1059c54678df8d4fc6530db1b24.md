...
# <a name="create-purchase-orders"></a>Create purchase orders
...
## <a name="creating-a-purchase-order-header"></a>Creating a purchase order header
...
## <a name="adding-purchase-order-lines"></a>Adding purchase order lines
...
## <a name="purchase-order-actions"></a>Purchase order actions
