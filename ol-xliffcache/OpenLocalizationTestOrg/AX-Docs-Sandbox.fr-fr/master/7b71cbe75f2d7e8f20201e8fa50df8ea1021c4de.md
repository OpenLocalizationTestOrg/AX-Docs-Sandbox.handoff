...
# <a name="set-up-bar-code-masks"></a>Set up bar code masks
...
<a name="set-up-bar-code-mask-characters"></a>Set up bar code mask characters
-------------------------------
...
## <a name="define-bar-code-masks"></a>Define bar code masks
...
## <a name="assign-bar-code-masks-to-bar-codes"></a>Assign bar code masks to bar codes
