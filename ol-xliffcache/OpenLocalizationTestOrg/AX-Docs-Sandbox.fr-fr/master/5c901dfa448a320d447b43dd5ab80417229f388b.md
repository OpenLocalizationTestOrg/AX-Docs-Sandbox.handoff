...
# <a name="item-and-raw-material-tracing-in-inventory-production-and-sales"></a>Item and raw material tracing in inventory, production, and sales
...
## <a name="what-is-item-tracing"></a>What is item tracing?
...
## <a name="what-can-i-trace-and-are-there-any-limitations"></a>What can I trace, and are there any limitations?
...
## <a name="what-criteria-can-i-specify-for-an-item-trace"></a>What criteria can I specify for an item trace?
...
## <a name="what-information-is-included-in-the-trace-details"></a>What information is included in the trace details?
...
## <a name="why-dont-some-nodes-contain-any-details"></a>Why don’t some nodes contain any details?
...
## <a name="can-i-view-only-a-particular-type-of-document-for-example-can-i-view-only-production-orders-customers-or-vendors"></a>Can I view only a particular type of document? For example, can I view only production orders, customers, or vendors?
...
## <a name="how-many-levels-can-i-trace-up-or-down-in-a-bom-or-formula"></a>How many levels can I trace up or down in a BOM or formula?
...
## <a name="how-can-i-view-more-details-about-a-document-or-transaction-in-the-trace-details"></a>How can I view more details about a document or transaction in the trace details?
...
## <a name="can-i-run-more-than-one-trace-and-then-compare-the-details"></a>Can I run more than one trace and then compare the details?
...
## <a name="can-i-save-the-trace-details"></a>Can I save the trace details?
...
## <a name="can-i-calculate-a-balance-for-a-particular-item-or-ingredient"></a>Can I calculate a balance for a particular item or ingredient?
...
## <a name="can-i-investigate-whether-there-is-a-history-of-issues-with-items-or-raw-materials"></a>Can I investigate whether there is a history of issues with items or raw materials?
...
## <a name="are-there-any-reporting-capabilities-that-are-related-to-item-tracing"></a>Are there any reporting capabilities that are related to item tracing?
