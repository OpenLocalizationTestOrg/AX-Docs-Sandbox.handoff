...
### <a name="pos-peripherals"></a>POS peripherals
...
## <a name="devices-classes"></a>Devices classes
...
### <a name="cash-drawer"></a>Cash drawer
...
### <a name="line-display"></a>Line display
...
### <a name="secondary-display"></a>Secondary display
...
### <a name="payment-device"></a>Payment device
...
## <a name="supported-interfaces"></a>Supported interfaces
### <a name="opos"></a>OPOS
...
## <a name="hardware-station-deployment-options"></a>Hardware station deployment options
### <a name="ipc-built-in"></a>IPC (built-in)
...
### <a name="network-peripherals"></a>Network peripherals
...
#### <a name="cloud-pos-modern-pos-for-ios-and-modern-pos-for-android"></a>Cloud POS, Modern POS for iOS, and Modern POS for Android
...
### <a name="hardware-station-installation"></a>Hardware station installation
...
### <a name="modern-pos-for-windows-setup-and-configuration"></a>Modern POS for Windows setup and configuration

For information, see [Retail Modern POS configuration and installation](retail-modern-pos-device-activation.md).

### <a name="opos-device-setup-and-configuration"></a>OPOS device setup and configuration
...
## <a name="supported-scenarios-by-hardware-station-type"></a>Supported scenarios by hardware station type
### <a name="client-support--ipc-hardware-station-vs-iis-hardware-station"></a>Client support – IPC hardware station vs. IIS hardware station
...
## <a name="supported-device-types-by-hardware-station-type"></a>Supported device types by hardware station type
### <a name="modern-pos-for-windows-with-an-ipc-built-in-hardware-station"></a>Modern POS for Windows with an IPC (built-in) hardware station
...
### <a name="all-modern-pos-clients-that-have-a-dedicated-iis-hardware-station"></a>All Modern POS clients that have a dedicated IIS hardware station
...
### <a name="all-modern-pos-clients-that-have-a-shared-iis-hardware-station"></a>All Modern POS clients that have a shared IIS hardware station
...
## <a name="configuration-for-supported-scenarios"></a>Configuration for supported scenarios
...
## <a name="peripheral-simulator"></a>Peripheral simulator
For information, see [Retail peripheral simulator](retail-peripheral-simulator.md).

## <a name="microsofttested-peripheral-devices"></a>Microsofttested peripheral devices
### <a name="ipc-built-in-hardware-station"></a>IPC (built-in) hardware station
...
#### <a name="bar-code-scanner"></a>Bar code scanner
...
#### <a name="payment-terminal"></a>Payment terminal
...
### <a name="dedicated-iis-hardware-station"></a>Dedicated IIS hardware station
...
### <a name="shared-iis-hardware-station"></a>Shared IIS hardware station
...
### <a name="modern-pos-can-detect-the-hardware-station-in-its-list-for-selection-but-it-cant-complete-the-pairing"></a>Modern POS can detect the hardware station in its list for selection, but it can’t complete the pairing
...
### <a name="modern-pos-cant-detect-the-hardware-station-in-its-list-for-selection"></a>Modern POS can’t detect the hardware station in its list for selection
...
### <a name="modern-pos-doesnt-reflect-new-cash-drawer-settings"></a>Modern POS doesn't reflect new cash drawer settings
...
### <a name="modern-pos-is-reporting-an-issue-with-a-retail-peripheral"></a>Modern POS is reporting an issue with a retail peripheral
