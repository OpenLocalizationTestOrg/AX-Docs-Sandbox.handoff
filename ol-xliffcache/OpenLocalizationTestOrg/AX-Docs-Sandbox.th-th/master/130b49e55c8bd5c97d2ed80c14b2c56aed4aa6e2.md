...
# ms.tgt_pltfrm: 
ms.custom: 16242
ms.assetid: 6fd45233-619c-4fea-aa5a-1c1f3efac5f3
# ms.region: 
# ms.industry: 
ms.author: jasongre
...
## Wireframe
![Wireframe](media/SimpleListAndDetails1-1024x575.png)
...
-   **When do I use icons on actions in the toolbars?**
    -   See the Button Image Guidelines in the [General Form Guidelines](http://ax.help.dynamics.com/en/wiki/general-form-guidelines/)document.
