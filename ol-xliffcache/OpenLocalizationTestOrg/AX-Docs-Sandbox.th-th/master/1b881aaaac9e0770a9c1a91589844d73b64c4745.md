...
# ms.tgt_pltfrm: 
ms.custom: 24191
ms.assetid: ea8c8136-3560-401e-ad35-4503903f9477
# ms.region: 
# ms.industry: 
ms.author: RobinARH
...
3.  View the runbook to see the completed steps. ![image013](media/image013-1024x978.png)

## Run database synchronization
-   At one point, you will see a database synchronization (DBSync) step. ![image015](media/image015-1024x654.png)
