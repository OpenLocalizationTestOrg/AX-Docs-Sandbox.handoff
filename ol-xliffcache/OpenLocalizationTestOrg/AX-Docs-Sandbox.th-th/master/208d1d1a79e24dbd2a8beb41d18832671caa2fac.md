...
# ms.tgt_pltfrm: 
ms.custom: 13281
ms.assetid: 2c6a6a0c-cbef-4f48-87df-b12c5eeb4ecd
# ms.region: 
# ms.industry: 
ms.author: annbe
...
13. The number and size of each virtual machine that will be deployed is listed. Change the number and size of the virtual machines, as needed.
    -   For information about the software installed on each virtual machine in this environment, see [Plan your Microsoft Dynamics AX 2012 R3 deployment on Azure](http://ax.help.dynamics.com/en/wiki/plan-your-microsoft-dynamics-ax-2012-r3-deployment-on-azure/).
...
Log on to the AOS-&lt;GUID&gt; virtual machine using the &lt;DomainName&gt;DynamicsInstallUser account. For instructions, see the “How do I log on to a virtual machine?” section of the [Manage your Microsoft Dynamics AX 2012 R3 deployment on Azure](http://ax.help.dynamics.com/en/wiki/manage-your-microsoft-dynamics-ax-2012-r3-deployment-on-azure/) article.
...
1.  Log on to the SQL-&lt;GUID&gt; virtual machine. Log on to the virtual machine using the DynamicsInstallUser account. For instructions, see the “How do I log on to a virtual machine?” section of the [Manage your Microsoft Dynamics AX 2012 R3 deployment on Azure](http://ax.help.dynamics.com/en/wiki/manage-your-microsoft-dynamics-ax-2012-r3-deployment-on-azure/) article.
