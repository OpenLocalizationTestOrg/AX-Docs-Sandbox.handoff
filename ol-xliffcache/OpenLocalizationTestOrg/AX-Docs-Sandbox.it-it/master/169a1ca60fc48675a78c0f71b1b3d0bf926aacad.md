...
# ms.tgt_pltfrm: 
ms.custom: 96283
ms.assetid: 4abf74b1-4753-4356-a7d3-15f5a806348d
# ms.region: 
# ms.industry: 
ms.author: annbe
...
2.  To view or edit the sequence, click the **Entity sequence** button on the Action Pane of the data project. ![DataEntitiesDataPackages01]
...
4.  On the next page, do the following:
    ...
    3.  Click the **Upload** button and choose the appropriate package file from the location for the data being imported. This will import all the files from the package. ![DataEntitiesDataPackages12](media/DataEntitiesDataPackages12-1024x555.png)
...
[Data entities](http://ax.help.dynamics.com/en/wiki/data-entities/)
