...
title: Usage profiler (Lifecycle Services, LCS) | Microsoft Docs
description: 
author: annbe
manager: AnnBe
...
# ms.tgt_pltfrm: 
ms.custom: 18751
ms.assetid: 53d570b6-0b9f-4ad7-85ed-a48f5531e7a5
# ms.region: 
# ms.industry: 
ms.author: annbe
...
## Prerequisites
If you want to import process data from Business process modeler, you must first complete the modeling of the organization. For more information, see [Business process modeler (Lifecycle Services, LCS)](http://ax.help.dynamics.com/en/wiki/business-process-modeler-lifecycle-services-lcs/).
