...
# ms.tgt_pltfrm: 
ms.custom: 18161
ms.assetid: 6a061b15-ccc0-46b2-8718-d7819f3b6c4f
# ms.region: 
# ms.industry: 
ms.author: annbe
...
5.  To specify the table as temporary, set the **Temporary** property to **Yes**. For more information, see [Table Properties](http://ax.help.dynamics.com/en/wiki/table-properties/).
6.  Modify additional table properties, as needed. For more information, see [Table Properties](http://ax.help.dynamics.com/en/wiki/table-properties/).
