# <a name="welcome-to-retail"></a>Welcome to Retail
...
## <a name="set-up-retail-channels"></a>Set up Retail channels
...
## <a name="set-up-a-call-center"></a>Set up a call center
...
## <a name="define-your-pos-and-mpos-solutions"></a>Define your POS and MPOS solutions
...
## <a name="customize-and-administer-retail-environments"></a>Customize and administer Retail environments
...
### <a name="whats-new-and-in-development"></a>What's new and in development
