---
title: Handing back first version of this file.Accounting distributions and subledger journal entries for free text invoices
description: Now handing back second time,of file with same version/filehash. Accounting distributions are used to define how an amount will be accounted for, such as how the revenue, tax, or charges will be accounted for on a free text invoice. Every amount that must be accounted for when the free text invoice is journalized will have one or more accounting distributions.
author: twheeloc
manager: AnnBe
...
ms.openlocfilehash: db3f156906b4ad62adf25705317d5d265f075d21
