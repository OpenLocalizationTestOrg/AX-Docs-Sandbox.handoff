...
# ms.tgt_pltfrm: 
ms.custom: 29191
ms.assetid: bb149cf8-9715-4b35-b540-ed390dd3815c
# ms.region: 
# ms.industry: 
ms.author: jasongre
...
![filterToolbarInlineWireframe]

### Filters and Toolbar - Stacked

![filterToolbarStackedWireframe]
...
Form: **HcmWorkforceManagement**  &gt; **HcmOpenPositionsPart** (**All workspaces** &gt; **Workforce management**) ![filterToolbarInline]

### Filters and Toolbar - Stacked

Form: **HcmWorkforceManagement** &gt; **HcmWorkerOnLeaveListPart** (**All workspaces** &gt; **Workforce management**) ![filterToolbarStacked]
