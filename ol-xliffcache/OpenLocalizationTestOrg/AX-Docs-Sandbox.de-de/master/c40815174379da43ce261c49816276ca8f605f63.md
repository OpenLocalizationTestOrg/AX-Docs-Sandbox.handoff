...
title: Localization requirements – Classify localization features | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 27601
ms.assetid: da87e31d-90c9-4a60-ab05-d134a3a8f7b6
ms.region: global
# ms.industry: 
ms.author: kfend
...
# Localization requirements – Classify localization features

These localization features must be classified as either regulatory or competitive in the Business process modeler (BPM) library in Microsoft Dynamics Lifecycle Services (LCS). The following definitions will help you distinguish the two types of features:
