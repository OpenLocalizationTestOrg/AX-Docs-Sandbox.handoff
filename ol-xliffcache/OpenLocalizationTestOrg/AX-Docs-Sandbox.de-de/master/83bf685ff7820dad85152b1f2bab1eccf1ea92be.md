...
description: THIS IS THE LATER v3 of this file taken from ol-handoff folder and not handed off before.This article gives an overview of the 200 percent reducing balance method of depreciation.
author: twheeloc
manager: AnnBe
...
ms.sourcegitcommit: 5f3bce1c1a1b7ee6732ab57cad422663ba576794
ms.openlocfilehash: 83bf685ff7820dad85152b1f2bab1eccf1ea92be
...
TEST UPDATE making a 3rd change to this file (v3) as want to test handback of earlier v2 for de-de.  Will wait for this file to make it to HO  ol-handoff first - call this V2This article gives an overview of the 200 percent reducing balance method of depreciation.
