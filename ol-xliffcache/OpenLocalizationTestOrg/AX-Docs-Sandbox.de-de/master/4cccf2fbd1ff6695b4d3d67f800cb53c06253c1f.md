---
title: TEST CHANGES WRITTEN TO basic folder and to sandbox.de-deCredit card setup, authorization, and capture | Microsoft Docs
...
ms.custom: 3041
ms.assetid: 4392e165-9fc8-419a-98d1-ed119019c915
ms.region: Global
ms.author: mfalkner
translationtype: Human Translation
ms.sourcegitcommit: f93e5e6c91b62ee2970869a2e9e183c75cd2b7fc
ms.openlocfilehash: 4cccf2fbd1ff6695b4d3d67f800cb53c06253c1f
...
-   TEST CHANGES WRITTEN TO basic folder and to sandbox.de-deOn the Accounts receivable parameters page, specify parameters for using credit card authorizations.
