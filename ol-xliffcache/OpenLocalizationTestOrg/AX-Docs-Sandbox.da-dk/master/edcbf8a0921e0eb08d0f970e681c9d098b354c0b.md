...
# <a name="configure-app-field-names-in-warehousing-app"></a>Configure app field names in Warehousing app
...
<a name="configure-warehouse-app-field-names"></a>Configure warehouse app field names
===================================
...
<a name="configure-warehouse-app-field-priority"></a>Configure warehouse app field priority
======================================
