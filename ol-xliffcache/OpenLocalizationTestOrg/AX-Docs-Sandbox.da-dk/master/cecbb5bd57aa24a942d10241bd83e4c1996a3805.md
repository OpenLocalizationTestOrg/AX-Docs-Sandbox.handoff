...
# <a name="manage-the-electronic-reporting-configuration-lifecycle"></a>Manage the Electronic reporting configuration lifecycle
...
## <a name="er-configuration-development-lifecycle"></a>ER configuration development lifecycle
