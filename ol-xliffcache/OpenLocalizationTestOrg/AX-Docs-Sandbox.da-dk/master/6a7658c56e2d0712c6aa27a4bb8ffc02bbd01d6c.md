...
# <a name="set-up-mobile-devices-for-warehouse-work"></a>Set up mobile devices for warehouse work
...
## <a name="configure-menu-items-for-activities-and-inquiries"></a>Configure menu items for activities and inquiries
...
## <a name="configure-menu-items-to-create-work-for-another-worker-or-process"></a>Configure menu items to create work for another worker or process
...
## <a name="configure-menu-items-to-process-existing-work"></a>Configure menu items to process existing work
...
## <a name="additional-menu-item-options"></a>Additional menu item options
...
## <a name="require-workers-to-confirm-the-product-location-or-quantity-when-they-pick-items"></a>Require workers to confirm the product, location, or quantity when they pick items
