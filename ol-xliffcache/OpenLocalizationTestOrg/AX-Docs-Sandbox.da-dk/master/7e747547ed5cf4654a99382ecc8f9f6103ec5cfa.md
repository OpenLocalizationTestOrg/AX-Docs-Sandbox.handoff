...
# <a name="manage-vendor-collaboration-users"></a>Manage vendor collaboration users
...
## <a name="vendor-collaboration-user-requests"></a>Vendor collaboration user requests
...
### <a name="provision-a-user"></a>Provision a user
...
### <a name="inactivate-a-user"></a>Inactivate a user
...
### <a name="modify-security-roles"></a>Modify security roles
