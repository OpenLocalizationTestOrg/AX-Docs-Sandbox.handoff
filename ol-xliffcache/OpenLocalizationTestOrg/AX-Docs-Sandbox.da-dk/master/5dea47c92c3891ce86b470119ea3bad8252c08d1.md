...
## <a name="overview-of-the-intrastat-reporting-process"></a>Overview of the Intrastat reporting process
The following sections describe the overall flow of information that is used for Intrastat reporting.

### <a name="1-enter-a-transaction-that-crosses-the-border-of-another-eu-countryregion"></a>1. Enter a transaction that crosses the border of another EU country/region
...
### <a name="2-use-the-intrastat-journal-to-generate-information-about-trade-among-eu-countriesregions"></a>2. Use the Intrastat journal to generate information about trade among EU countries/regions
...
### <a name="3-use-the-intrastat-journal-to-report-information-about-trade-among-eu-countriesregions"></a>3. Use the Intrastat journal to report information about trade among EU countries/regions
...
### <a name="set-up-all-required-intrastat-related-lists"></a>Set up all required Intrastat-related lists
...
### <a name="set-up-rules-for-compressing-intrastat-transactions"></a>Set up rules for compressing Intrastat transactions
...
### <a name="set-up-foreign-trade-parameters"></a>Set up foreign trade parameters
