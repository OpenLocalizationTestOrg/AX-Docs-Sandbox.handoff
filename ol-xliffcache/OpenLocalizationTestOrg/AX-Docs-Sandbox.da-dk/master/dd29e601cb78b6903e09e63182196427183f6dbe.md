...
# <a name="lean-manufacturing-overview"></a>Lean manufacturing overview
...
## <a name="modeling-manufacturing-and-logistics-processes-as-production-flows"></a>Modeling manufacturing and logistics processes as production flows
...
## <a name="using-kanbans-to-signal-demand-requirements"></a>Using kanbans to signal demand requirements
...
## <a name="monitoring-and-maintaining-kanban-jobs"></a>Monitoring and maintaining kanban jobs
...
## <a name="kanban-jobs-and-integration-with-microsoft-dynamics-ax-processes"></a>Kanban jobs and integration with Microsoft Dynamics AX processes
