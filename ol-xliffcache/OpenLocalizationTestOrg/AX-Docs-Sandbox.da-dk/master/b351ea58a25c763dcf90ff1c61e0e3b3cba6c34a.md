...
### <a name="option-1-by-cash-discount"></a>Option 1: By cash discount
...
### <a name="option-2-by-due-date"></a>Option 2: By due date
...
### <a name="option-3-by-due-date-and-cash-discount"></a>Option 3: By due date and cash discount
...
## <a name="country-specific-considerations"></a>Country specific considerations
### <a name="norway"></a>Norway

#### <a name="dimension-control"></a>Dimension control
