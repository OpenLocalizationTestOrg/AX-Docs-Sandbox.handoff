...
ms.openlocfilehash: 92449fb2e373b97894e184dd66763bf82b87dcd5
...
# <a name="install-and-configure-microsoft-dynamics-365-for-operations-8211-warehousing"></a>Install and configure Microsoft Dynamics 365 for Operations &#8211; Warehousing
...
## <a name="get-the-app"></a>Get the app
...
## <a name="create-a-web-service-application-in-active-directory"></a>Create a web service application in Active Directory
...
## <a name="create-and-configure-a-user-account-in-dynamics-365-for-operations"></a>Create and configure a user account in Dynamics 365 for Operations
...
## <a name="remove-access-for-a-device"></a>Remove access for a device
