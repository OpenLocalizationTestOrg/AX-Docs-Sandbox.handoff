...
## <a name="example-price-matching-and-intercompany-trade"></a>Example: Price matching and intercompany trade
...
## <a name="example-quantity-matching-with-intercompany-trade"></a>Example: Quantity matching with intercompany trade
