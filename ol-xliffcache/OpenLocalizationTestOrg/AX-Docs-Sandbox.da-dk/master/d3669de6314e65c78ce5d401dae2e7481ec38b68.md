...
# <a name="procurement-and-sourcing-overview"></a>Procurement and sourcing overview
...
## <a name="identifying-a-need-for-product-and-services"></a>Identifying a need for product and services
...
### <a name="delivery-options"></a>Delivery options
...
### <a name="supplementary-items"></a>Supplementary items
...
### <a name="purchase-order-charges"></a>Purchase order charges
