...
# <a name="financial-report-components"></a>Financial report components
...
## <a name="building-blocks-of-a-report"></a>Building blocks of a report
...
## <a name="organize-the-building-blocks"></a>Organize the building blocks
...
### <a name="create-a-folder"></a>Create a folder
...
## <a name="lock-a-building-block"></a>Lock a building block
...
## <a name="building-block-groups"></a>Building block groups
...
### <a name="create-a-building-block-group"></a>Create a building block group
...
### <a name="assign-a-building-block-group"></a>Assign a building block group
...
### <a name="view-a-building-block-group"></a>View a building block group
...
### <a name="save-a-building-block-group-under-a-new-name"></a>Save a building block group under a new name
...
### <a name="export-a-building-block-group"></a>Export a building block group
...
### <a name="import-a-building-block-group"></a>Import a building block group
...
### <a name="undo-a-checkout-of-a-building-block"></a>Undo a checkout of a building block
