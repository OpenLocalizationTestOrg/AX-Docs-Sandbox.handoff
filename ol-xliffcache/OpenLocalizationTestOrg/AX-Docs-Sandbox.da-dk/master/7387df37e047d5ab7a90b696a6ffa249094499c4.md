...
# <a name="inventory-on-hand-mobile-workspace"></a>Inventory on-hand mobile workspace
...
<a name="overview-of-the-inventory-on-hand-mobile-workspace"></a>Overview of the Inventory on-hand mobile workspace
--------------------------------------------------
...
## <a name="view-the-onhand-inventory-for-a-product-by-using-the-inventory-onhand-mobile-workspace"></a>View the onhand inventory for a product by using the Inventory onhand mobile workspace
