...
# <a name="reporting-tree-definitions-in-financial-reports"></a>Reporting tree definitions in financial reports
...
## <a name="reporting-tree-best-practices"></a>Reporting tree best practices
...
## <a name="create-multiple-reporting-trees"></a>Create multiple reporting trees
...
## <a name="create-a-reporting-tree-definition"></a>Create a reporting tree definition
...
### <a name="open-an-existing-reporting-tree-definition"></a>Open an existing reporting tree definition
...
### <a name="roll-up-data-in-a-reporting-tree"></a>Roll up data in a reporting tree
...
### <a name="manage-reporting-units"></a>Manage reporting units
...
### <a name="reporting-unit-structure"></a>Reporting unit structure
...
### <a name="organize-reporting-units"></a>Organize reporting units
...
### <a name="add-text-about-a-reporting-unit"></a>Add text about a reporting unit
...
### <a name="remove-additional-text-from-a-reporting-unit"></a>Remove additional text from a reporting unit
...
### <a name="restrict-access-to-a-reporting-unit"></a>Restrict access to a reporting unit
...
### <a name="remove-access-to-a-reporting-unit"></a>Remove access to a reporting unit
...
### <a name="link-to-reports"></a>Link to reports
...
### <a name="identify-the-report-in-a-reporting-tree"></a>Identify the report in a reporting tree
...
### <a name="reporting-unit-structure--example-1"></a>Reporting unit structure – Example 1
...
### <a name="reporting-unit-structure--example-2"></a>Reporting unit structure – Example 2
...
### <a name="example-of-the-insert-reporting-units-from-dimensions-dialog-box"></a>Example of the Insert Reporting Units from Dimensions dialog box
...
### <a name="examples-of-data-roll-up"></a>Examples of data roll-up
