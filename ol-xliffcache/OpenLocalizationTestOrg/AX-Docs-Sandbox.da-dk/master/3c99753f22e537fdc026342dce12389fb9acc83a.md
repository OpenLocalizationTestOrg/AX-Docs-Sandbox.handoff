...
<a name="task-guides-in-the-february-2016-apqc-unified-library-for-microsoft-dynamics-365-for-operations"></a>Task guides in the (February 2016) APQC Unified Library for Microsoft Dynamics 365 for Operations
---------------------------------------------------------------------------------
...
### <a name="cash-and-bank-management"></a>Cash and bank management
...
### <a name="develop-vision-and-strategy"></a>Develop Vision and Strategy
...
## <a name="task-guides-in-the-february-2016-getting-started-library"></a>Task guides in the (February 2016) Getting started library
|                                                    |                    |
|----------------------------------------------------|--------------------|
| **BPM Line**                                       | **Country/Region** |
