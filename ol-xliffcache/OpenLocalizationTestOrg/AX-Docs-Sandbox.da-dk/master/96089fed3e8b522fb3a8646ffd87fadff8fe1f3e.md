...
# <a name="lifo-date-with-physical-value-and-marking"></a>LIFO Date with physical value and marking
...
## <a name="lifo-date-without-the-include-physical-value-option"></a>LIFO Date without the Include physical value option
...
## <a name="lifo-date-with-the-include-physical-value-option"></a>LIFO Date with the Include physical value option
...
## <a name="lifo-date-with-marking"></a>LIFO Date with marking
