...
# <a name="price-simulation"></a>Price simulation
...
## <a name="price-simulation-and-discounts"></a>Price simulation and discounts
...
### <a name="types-of-discounts-in-trade-agreements"></a>Types of discounts in trade agreements
...
### <a name="quotation-lines-and-trade-agreements"></a>Quotation lines and trade agreements
...
## <a name="price-simulation-examples"></a>Price simulation examples
The following examples use price simulation for quotation headers and single line items.

### <a name="price-simulation-for-quotation-headers"></a>Price simulation for quotation headers
...
### <a name="price-simulation-for-single-line-items"></a>Price simulation for single line items
