...
# <a name="mobile-invoice-approvals"></a>Mobile invoice approvals
...
## <a name="designing-a-simple-invoice-approval-scenario-for-contoso"></a>Designing a simple invoice approval scenario for Contoso
<table>
<colgroup>
<col width="50%" />
<col width="50%" />
...
### <a name="create-the-workspace"></a>Create the workspace
...
### <a name="vendor-invoices-assigned-to-me"></a>Vendor invoices assigned to me
...
### <a name="vendor-invoice-details"></a>Vendor invoice details
...
### <a name="vendor-invoice-attachments"></a>Vendor invoice attachments
...
### <a name="vendor-invoice-line-distributions"></a>Vendor invoice line distributions
...
## <a name="designing-a-complex-invoice-approval-scenario-for-fabrikam"></a>Designing a complex invoice approval scenario for Fabrikam
<table>
<colgroup>
<col width="50%" />
<col width="50%" />
