...
# <a name="fifo-with-physical-value-and-marking"></a>FIFO with physical value and marking
...
## <a name="fifo-without-the-include-physical-value-option"></a>FIFO without the Include physical value option
...
## <a name="fifo-with-the-include-physical-value-option"></a>FIFO with the Include physical value option
...
## <a name="fifo-with-marking"></a>FIFO with marking
