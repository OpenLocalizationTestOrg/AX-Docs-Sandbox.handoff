...
# <a name="prepayment-invoices-vs-prepayments"></a>Prepayment invoices vs. prepayments
...
## <a name="when-to-use-prepayment-invoicing-vs-prepayments"></a>When to use prepayment invoicing vs. prepayments
...
## <a name="overview-of-the-prepayment-process"></a>Overview of the prepayment process
...
## <a name="overview-of-the-prepayment-invoicing-process"></a>Overview of the prepayment invoicing process
