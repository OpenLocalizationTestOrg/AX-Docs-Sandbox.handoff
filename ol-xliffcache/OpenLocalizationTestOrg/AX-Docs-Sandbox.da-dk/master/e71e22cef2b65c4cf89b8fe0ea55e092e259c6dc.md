...
# <a name="create-fixed-compensation-plans"></a>Create fixed compensation plans
...
## <a name="fixed-compensation-components"></a>Fixed compensation components
### <a name="compensation-levels"></a>Compensation levels
...
### <a name="reference-points"></a>Reference points
...
### <a name="compensation-grids"></a>Compensation grids
...
### <a name="pay-frequencies"></a>Pay frequencies
...
## <a name="fixed-compensation-plans"></a>Fixed compensation plans
...
## <a name="fixed-compensation-enrollment"></a>Fixed compensation enrollment
...
### <a name="define-fixed-compensation-actions"></a>Define fixed compensation actions
