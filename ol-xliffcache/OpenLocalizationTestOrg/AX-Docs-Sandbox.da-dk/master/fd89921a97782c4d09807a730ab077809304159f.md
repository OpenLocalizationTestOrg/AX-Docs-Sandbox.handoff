...
# <a name="create-a-customer-invoice"></a>Create a customer invoice
...
## <a name="post-and-print-individual-customer-invoices-that-are-based-on-sales-orders"></a>Post and print individual customer invoices that are based on sales orders
...
## <a name="post-and-print-individual-customer-invoices-that-are-based-on-packing-slips-and-the-date"></a>Post and print individual customer invoices that are based on packing slips and the date
...
## <a name="consolidate-sales-orders-or-packing-slips-for-posting"></a>Consolidate sales orders or packing slips for posting
...
## <a name="additional-settings-that-change-the-posting-behavior"></a>Additional settings that change the posting behavior
