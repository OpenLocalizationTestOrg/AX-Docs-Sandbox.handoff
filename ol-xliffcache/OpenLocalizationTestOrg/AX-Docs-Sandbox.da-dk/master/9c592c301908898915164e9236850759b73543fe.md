...
# <a name="project-time-entry-mobile-workspace"></a>Project time entry mobile workspace
...
<a name="overview-of-the-project-time-entry-mobile-workspace"></a>Overview of the Project time entry mobile workspace
---------------------------------------------------
...
## <a name="enter-time-by-using-the-project-time-entry-mobile-workspace"></a>Enter time by using the Project time entry mobile workspace
