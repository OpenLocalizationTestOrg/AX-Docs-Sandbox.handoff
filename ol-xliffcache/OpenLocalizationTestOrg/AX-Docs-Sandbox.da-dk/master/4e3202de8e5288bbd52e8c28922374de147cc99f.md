...
# <a name="expense-management-mobile-workspace"></a>Expense management mobile workspace
...
<a name="overview-of-the-expense-management-mobile-workspace"></a>Overview of the Expense management mobile workspace
---------------------------------------------------
...
## <a name="capture-a-receipt-by-using-the-expense-management-mobile-workspace"></a>Capture a receipt by using the Expense management mobile workspace
...
## <a name="quick-expense-entry-by-using-the-expense-management-mobile-workspace"></a>Quick expense entry by using the Expense management mobile workspace
1.  On your mobile device, select the **Expense management** workspace.
