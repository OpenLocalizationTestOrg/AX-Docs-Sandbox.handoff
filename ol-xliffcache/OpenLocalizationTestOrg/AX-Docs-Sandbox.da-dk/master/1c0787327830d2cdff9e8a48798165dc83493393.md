...
# <a name="view-and-design-financial-reports"></a>View and design financial reports
...
<a name="exercise-1-generate-and-explore-a-default-financial-report"></a>Exercise 1: Generate and explore a default financial report
-----------------------------------------------------------
...
## <a name="exercise-2-add-additional-account-properties-to-a-report-design"></a>Exercise 2: Add additional account properties to a report design
...
## <a name="exercise-3-create-a-multidimensional-report-using-a-reporting-tree"></a>Exercise 3: Create a multidimensional report using a reporting tree
...
## <a name="exercise-4-create-a-consolidated-report-using-an-organization-hierarchy"></a>Exercise 4: Create a consolidated report using an organization hierarchy
...
## <a name="exercise-5-create-a-sidebyside-departmental-report"></a>Exercise 5: Create a sidebyside departmental report
