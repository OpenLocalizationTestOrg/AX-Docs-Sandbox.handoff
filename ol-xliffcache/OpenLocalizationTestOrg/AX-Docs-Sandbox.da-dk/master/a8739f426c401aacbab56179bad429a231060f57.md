...
# <a name="organize-report-components-in-report-designer"></a>Organize report components in report designer
...
## <a name="rename-a-folder-or-building-block-in-report-designer"></a>Rename a folder or building block in Report Designer
...
## <a name="create-and-manage-report-groups"></a>Create and manage report groups
...
### <a name="create-a-report-group"></a>Create a report group
...
### <a name="modify-a-report-group"></a>Modify a report group
...
### <a name="generate-a-report-group-report"></a>Generate a report group report
...
### <a name="delete-a-report-group"></a>Delete a report group

1.  In Report Designer, in the navigation pane, click **Report Groups**.
2.  Right-click the report group to delete, and then select **Delete**.
3.  When a confirmation message appears, click **Yes**.

## <a name="report-group-tab-controls"></a>Report Group tab controls
