...
# <a name="control-warehouse-work-by-using-work-templates-and-location-directives"></a>Control warehouse work by using work templates and location directives
