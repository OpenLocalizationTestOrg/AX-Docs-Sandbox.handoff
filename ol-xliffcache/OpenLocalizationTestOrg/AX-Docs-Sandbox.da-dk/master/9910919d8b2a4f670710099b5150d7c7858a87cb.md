...
# <a name="lifo-with-physical-value-and-marking"></a>LIFO with physical value and marking
...
## <a name="lifo-without-the-include-physical-value-option"></a>LIFO without the Include physical value option
...
## <a name="lifo-with-the-include-physical-value-option"></a>LIFO with the Include physical value option
...
## <a name="lifo-with-marking"></a>LIFO with marking
