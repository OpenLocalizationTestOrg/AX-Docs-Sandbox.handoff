...
### <a name="questionnaire-types"></a>Questionnaire types
...
### <a name="questionnaire-parameters"></a>Questionnaire parameters
...
## <a name="questionnaire-components"></a>Questionnaire components
...
### <a name="answer-groups-and-answers"></a>Answer groups and answers
...
## <a name="setting-up-questionnaires"></a>Setting up questionnaires
>**Note**
...
### <a name="set-up-a-questionnaire"></a>Set up a questionnaire
...
### <a name="modify-a-questionnaire"></a>Modify a questionnaire
...
### <a name="result-groups"></a>Result groups
...
#### <a name="example-pointstexts-for-result-group-3"></a>Example: Points/texts for result group 3
...
### <a name="conditional-question-hierarchies"></a>Conditional question hierarchies
