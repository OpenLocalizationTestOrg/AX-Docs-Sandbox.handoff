...
## <a name="preparing-the-legal-entity-for-currency-conversion"></a>Preparing the legal entity for currency conversion
...
## <a name="setting-up-accounts-for-automatic-transactions"></a>Setting up accounts for automatic transactions
...
## <a name="posting-rounding-differences-and-sum-recalculations"></a>Posting rounding differences and sum recalculations
...
## <a name="processing-the-currency-conversion"></a>Processing the currency conversion
...
## <a name="completing-the-currency-conversion"></a>Completing the currency conversion
