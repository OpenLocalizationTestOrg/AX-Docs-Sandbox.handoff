...
# <a name="overhead-calculation"></a>Overhead calculation
...
<a name="term-definition"></a>Term definition
---------------
...
## <a name="overhead-calculation-overview"></a>Overhead calculation overview
...
## <a name="calculate-and-allocate-the-electricity-overhead-cost"></a>Calculate and allocate the Electricity overhead cost
...
### <a name="step-1-process-the-cost-behavior-calculation"></a>Step 1: Process the cost behavior calculation
...
#### <a name="define-the-cost-behavior-rule"></a>Define the cost behavior rule
...
##### <a name="journal-entries-cost-object-balance-journal-entries"></a>Journal entries (Cost object balance journal entries)
...
### <a name="step-2-process-the-cost-distribution-calculation"></a>Step 2: Process the cost distribution calculation
...
#### <a name="define-the-cost-distribution-rule"></a>Define the cost distribution rule
...
### <a name="step-3-process-the-overhead-rate-calculation"></a>Step 3: Process the overhead rate calculation
...
#### <a name="define-the-overhead-rate"></a>Define the overhead rate
...
##### <a name="journal-entries-journal-entries-for-overhead-rate-calculation"></a>Journal entries (Journal entries for overhead rate calculation)
...
##### <a name="journal-lines"></a>Journal lines
