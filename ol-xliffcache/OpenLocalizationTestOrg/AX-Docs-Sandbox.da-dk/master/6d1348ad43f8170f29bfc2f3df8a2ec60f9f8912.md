...
# <a name="accounts-payable-invoice-matching"></a>Accounts payable invoice matching
...
## <a name="invoice-totals-matching"></a>Invoice totals matching
...
## <a name="two-way-price-totals-matching"></a>Two-way, price totals matching
...
## <a name="two-way-net-unit-price-matching"></a>Two-way, net unit price matching
...
## <a name="two-way-price-totals-matching-and-net-unit-price-matching"></a>Two-way, price totals matching and net unit price matching
...
## <a name="three-way-matching"></a>Three-way matching
...
## <a name="charges-matching"></a>Charges matching
...
## <a name="related-functionality"></a>Related functionality
