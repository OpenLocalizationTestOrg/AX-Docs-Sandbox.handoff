...
# <a name="warehouse-mobile-device-display-settings"></a>Warehouse mobile device display settings
...
## <a name="specify-styles-and-map-keyboard-shortcuts"></a>Specify styles and map keyboard shortcuts
...
## <a name="define-text-colors-for-messages"></a>Define text colors for messages
...
## <a name="define-the-date-format-to-use-on-mobile-devices"></a>Define the date format to use on mobile devices
