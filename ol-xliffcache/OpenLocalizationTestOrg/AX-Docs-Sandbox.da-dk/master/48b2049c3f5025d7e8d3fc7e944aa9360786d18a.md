...
# <a name="advanced-filtering-and-query-syntax"></a>Advanced filtering and query syntax
...
<a name="advanced-query-syntax"></a>Advanced query syntax
---------------------
...
## <a name="advanced-date-queries-that-use-sysqueryrangeutil-methods"></a>Advanced date queries that use SysQueryRangeUtil methods
<table>
<colgroup>
<col width="33%" />
<col width="33%" />
