...
# <a name="project-contracts"></a>Project contracts
...
## <a name="funding-for-project-contracts"></a>Funding for project contracts
...
### <a name="example-multiple-funding-sources-simple"></a>Example: Multiple funding sources (simple)
...
### <a name="example-multiple-funding-sources-complex"></a>Example: Multiple funding sources (complex)
...
## <a name="billing-rules"></a>Billing rules
...
### <a name="example-create-a-billing-rule-that-is-based-on-the-number-of-units-delivered"></a>Example: Create a billing rule that is based on the number of units delivered
...
### <a name="example-create-a-billing-rule-that-is-based-on-a-specified-percentage-of-project-completion-manual-calculation"></a>Example: Create a billing rule that is based on a specified percentage of project completion (manual calculation)
...
### <a name="example-create-a-billing-rule-that-is-based-on-a-specified-percentage-of-project-completion-automatic-calculation"></a>Example: Create a billing rule that is based on a specified percentage of project completion (automatic calculation)
...
### <a name="example-create-a-billing-rule-that-is-based-on-agreed-upon-milestones"></a>Example: Create a billing rule that is based on agreed-upon milestones
...
### <a name="example-create-a-billing-rule-that-is-based-on-services-plus-a-management-fee"></a>Example: Create a billing rule that is based on services plus a management fee
...
### <a name="example-create-a-billing-rule-for-the-value-of-time-and-materials"></a>Example: Create a billing rule for the value of time and materials
