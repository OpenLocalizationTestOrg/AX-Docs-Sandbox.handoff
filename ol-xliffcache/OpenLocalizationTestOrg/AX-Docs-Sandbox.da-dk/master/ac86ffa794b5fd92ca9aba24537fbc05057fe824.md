...
## <a name="name-the-decision"></a>Name the decision
...
## <a name="specify-the-possible-outcomes-of-a-decision"></a>Specify the possible outcomes of a decision
...
## <a name="assign-a-decision"></a>Assign a decision
...
## <a name="specify-what-happens-when-a-decision-is-overdue"></a>Specify what happens when a decision is overdue
