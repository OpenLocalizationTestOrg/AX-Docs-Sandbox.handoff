...
## <a name="projects-across-industries"></a>Projects across industries
...
## <a name="project-phases"></a>Project phases
...
## <a name="initiate-the-project"></a>Initiate the project
...
### <a name="create-project-quotations"></a>Create project quotations
...
### <a name="create-project-contracts"></a>Create project contracts
...
### <a name="create-work-breakdown-structures"></a>Create work breakdown structures
...
### <a name="create-project-forecasts-and-budgets"></a>Create project forecasts and budgets
...
### <a name="assign-workers-categories-and-resources"></a>Assign workers, categories, and resources
...
## <a name="execute-the-project"></a>Execute the project
...
### <a name="manage-work-breakdown-structures"></a>Manage work breakdown structures
...
### <a name="manage-project-forecasts-and-budgets"></a>Manage project forecasts and budgets
...
### <a name="procure-products-and-services"></a>Procure products and services

The purchase and sale of items are prevalent activities in many project-focused businesses.

#### <a name="purchase-orders-for-projects"></a>Purchase orders for projects
...
#### <a name="sales-orders-for-projects"></a>Sales orders for projects
...
### <a name="process-project-invoices"></a>Process project invoices
...
### <a name="calculate-the-cost-to-complete-a-project"></a>Calculate the cost to complete a project
...
> [!NOTE] When you select this method, use at least two forecast models. One model should contain the original forecast. For the other model, you should copy forecast transactions from another model. This method is valid only for Fixed-prices and Investment projects.</td>
> </tr>
<tr class="odd">
...
## <a name="analyze-the-project"></a>Analyze the project
...
### <a name="analyze-cash-flow"></a>Analyze cash flow
...
#### <a name="cash-inflow-forecasting"></a>Cash inflow forecasting
...
#### <a name="actual-cash-inflow"></a>Actual cash inflow
...
#### <a name="cost-forecasting"></a>Cost forecasting
...
### <a name="review-costs"></a>Review costs
...
#### <a name="viewing-the-remaining-budgeted-amounts"></a>Viewing the remaining budgeted amounts
...
#### <a name="viewing-the-total-budgeted-amounts"></a>Viewing the total budgeted amounts
...
### <a name="analyze-utilization"></a>Analyze utilization
...
### <a name="review-project-statements"></a>Review project statements
