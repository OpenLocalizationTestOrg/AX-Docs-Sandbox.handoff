...
<a name="bills-of-materials"></a>Bills of materials
------------------
...
### <a name="formulas-co-products-and-by-products"></a>Formulas, co-products, and by-products
...
### <a name="boms-in-the-product-lifecycle"></a>BOMs in the product lifecycle
...
### <a name="approval-of-boms-and-formulas"></a>Approval of BOMs and formulas
...
## <a name="bom-and-formula-versions"></a>BOM and formula versions
...
### <a name="approval-of-bom-and-formula-versions"></a>Approval of BOM and formula versions
...
### <a name="activation-of-the-default-bom-or-formula-version"></a>Activation of the default BOM or formula version
...
### <a name="product-change-with-case-management"></a>Product change with case management
...
### <a name="alternative-bom-versions"></a>Alternative BOM versions
...
## <a name="bom-and-formula-lines"></a>BOM and formula lines
...
### <a name="pegged-supply"></a>Pegged supply
