...
## <a name="accounts-receivable-free-text-invoice-cash-on-delivery-cash-payment-settlement-example"></a>Accounts receivable free text invoice cash-on-delivery (cash payment) settlement example
...
## <a name="examples-general-ledger-year-end-close"></a>Examples: General ledger year-end close
