...
title: Garnishment and tax levy setup tasks | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 221114
ms.assetid: aee907d0-bce3-4eac-b939-82686dfd4fd4
ms.region: USA
# ms.industry: 
ms.author: rschloma
...
**Note:** In this topic, the term *garnishment* implies both garnishments and tax levies, unless the text specifies otherwise. For more information about the concepts that are discussed in this topic, see [Garnishments, tax levies, and administrative fees](http://ax.help.dynamics.com/en/wiki/garnishments-tax-levies-and-administrative-fees/).
...
## Next step
The next step is to enroll workers in garnishments and tax levies. For more information, see [Garnishment and tax levy enrollment tasks](http://ax.help.dynamics.com/en/wiki/garnishment-and-tax-levy-enrollment-tasks/).    
