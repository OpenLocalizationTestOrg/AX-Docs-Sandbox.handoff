...
title: Premium earning setup tasks | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 221084
ms.assetid: 734012c0-f26f-460b-b57c-d1a901257530
ms.region: USA
# ms.industry: 
ms.author: rschloma
...
| Related configuration tasks     | Complete the basic setup of Payroll before you set up premiums. Note that work cycles and work periods are required for regular-rate-of-pay premiums. For more information, see [Work cycle and work period tasks](http://ax.help.dynamics.com/en/wiki/work-cycle-and-work-period-tasks/). |
