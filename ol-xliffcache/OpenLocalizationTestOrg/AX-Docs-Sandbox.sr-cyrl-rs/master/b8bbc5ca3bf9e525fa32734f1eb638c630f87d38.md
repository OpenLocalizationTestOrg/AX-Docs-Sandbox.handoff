...
# ms.tgt_pltfrm: 
ms.custom: 31221
ms.assetid: 8fe14dcc-b91f-4e40-8258-13b137c2f246
ms.region: France
# ms.industry: 
...
First, you can use the Form setup page to set up the parameters to print lump sum recovery text. Next, you can use the Posting invoice page or the Invoice journal page to print the lump sum recovery text on a customer invoice. For more information, see [Configure and print a lump sum recovery text on a customer invoice](http://ax.help.dynamics.com/en/wiki/fra-configure-and-print-a-lump-sum-recovery-text-on-a-customer-invoice/).
