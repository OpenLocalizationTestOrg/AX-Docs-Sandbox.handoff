...
# ms.tgt_pltfrm: 
ms.custom: 219714
ms.assetid: 02fc7616-e888-4776-b25b-adf75cbf9ef8
# ms.region: 
ms.industry: Retail
ms.author: MargoC
...
To get started, review the following topic on configuring the Store Scale Unit, [Retail Store Scale Unit configuration and installation](http://ax.help.dynamics.com/en/wiki/retail-store-scale-unit-configuration-and-installation/).

See also
--------

[Retail Store Scale Unit download and configuration through self-service](http://ax.help.dynamics.com/en/wiki/retail-store-scale-unit-configuration-and-installation/)
