...
# ms.tgt_pltfrm: 
ms.custom: 58771
ms.assetid: 77e9be53-055a-4450-bd3e-03b449bd2802
# ms.region: 
# ms.industry: 
ms.author: kfend
...
ER lets you extend the list of functions that are used in ER expressions. Some engineering efforts are required. For detailed information, see [Extending the list of Electronic reporting functions](http://ax.help.dynamics.com/en/wiki/general-electronic-reporting-ger-formulas-list-extension/).
...
[Extend the list of Electronic reporting (ER) functions](http://ax.help.dynamics.com/en/wiki/general-electronic-reporting-ger-formulas-list-extension/)
