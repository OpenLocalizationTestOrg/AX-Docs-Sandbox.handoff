...
# ms.tgt_pltfrm: 
ms.custom: 51631
ms.assetid: ca801902-2df6-4480-868c-2cccde456050
# ms.region: 
# ms.industry: 
...
When you post a tag counting journal, a new counting journal is created, based on the tag counting journal lines. For more information about tag counting, see [Inventory tag counting](http://ax.help.dynamics.com/en/wiki/inventory-tag-counting/).
