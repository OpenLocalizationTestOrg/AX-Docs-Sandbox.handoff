...
title: Scenario: Settle a partial customer payment before the discount date with a final payment after the discount date | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 14584
ms.assetid: 7b097883-9b7b-473f-a961-2c2a33bfb891
# ms.region: 
# ms.industry: 
ms.author: twheeloc
