...
title: Plan your Microsoft Dynamics AX 2012 R3 deployment on Azure | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 18591
ms.assetid: 87d17c95-29b5-4fdc-814e-dc062103b8b7
# ms.region: 
# ms.industry: 
ms.author: annbe
...
After you purchase an Azure subscription, you can access the management portal by clicking [here.](https://manage.windowsazure.com/?whr=live.com) The following image shows the management portal. ![PlanYouAXR3DeploymentonAzure1]  
...
## Next steps
[Deploy an AX 2012 R3 or AX 2012 R3 CU8 demo environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-an-ax-2012-r3-or-ax-2012-r3-cu8-demo-environment-on-azure/) [Deploy a Retail essentials demo environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-retail-essentials-demo-environment-on-azure/) [Deploy a development environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-development-environment-on-azure/) [Deploy a test environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-test-environment-on-azure/) [Deploy a Retail essentials dev/test environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-retail-essentials-devtest-environment-on-azure/) [Deploy a Retail e-commerce dev/test environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-retail-e-commerce-devtest-environment-on-azure/) [Deploy a Retail mobility dev/test environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-retail-mobility-devtest-environment-on-azure/) [Deploy a high availability environment on Azure](http://ax.help.dynamics.com/en/wiki/deploy-a-high-availability-environment-on-azure/)
