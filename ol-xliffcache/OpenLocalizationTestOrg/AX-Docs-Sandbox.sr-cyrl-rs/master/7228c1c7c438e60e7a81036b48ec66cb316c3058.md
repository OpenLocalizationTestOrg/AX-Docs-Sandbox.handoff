...
title: Configuration of security for Vendor portal users | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 30231
ms.assetid: 96af25c9-6a4a-4bc4-8752-eb05bd38ae03
# ms.region: 
# ms.industry: 
...
# Configuration of security for Vendor portal users
...
[Vendor collaboration](http://ax.help.dynamics.com/en/wiki/collaborating-with-vendors-using-the-vendor-portal/)
