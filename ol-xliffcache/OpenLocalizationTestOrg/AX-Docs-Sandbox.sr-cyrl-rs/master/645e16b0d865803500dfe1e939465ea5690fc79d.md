...
# ms.tgt_pltfrm: 
ms.custom: 221534
ms.assetid: 77b58a5c-feb4-4620-bc91-b77235a94442
# ms.region: 
# ms.industry: 
ms.author: twheeloc
...
[Collaborating with vendors by using the Vendor portal](http://ax.help.dynamics.com/en/wiki/collaborating-with-vendors-using-the-vendor-portal/)
