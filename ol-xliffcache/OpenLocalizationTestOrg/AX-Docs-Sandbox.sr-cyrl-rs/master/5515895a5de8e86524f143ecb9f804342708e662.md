...
# ms.tgt_pltfrm: 
ms.custom: 50711
ms.assetid: 7597cda3-7fad-4a0a-b9a3-67c7776e1a55
# ms.region: 
...
Microsoft Dynamics 365 for Operations has two warehouse solutions: "Inventory management" warehousing or "Basic warehousing", which is available in the **Inventory management** module, and the "Advanced" warehousing solution that's available in the **Warehouse management** module. This page gives an overview of the resources that are available in the **Warehouse management** module. For information about Inventory management warehousing, see the [Inventory management home page](http://ax.help.dynamics.com/en/wiki/inventory-management/).
...
-   [Warehouse configuration](http://ax.help.dynamics.com/en/wiki/warehouse-configuration/)
...
-   [Unit of measure and stocking policies](http://ax.help.dynamics.com/en/wiki/unit-of-measure-and-stocking-policies/)
-   [Manage warehouse workers](http://ax.help.dynamics.com/en/wiki/manage-warehouse-workers/)
-   [Controlling warehouse work with work templates and location directives](http://ax.help.dynamics.com/en/wiki/controlling-warehouse-work-with-work-templates-and-location-directives/)
...
-   [Configuration of mobile devices for warehouse work](http://ax.help.dynamics.com/en/wiki/configure-mobile-devices-for-warehouse-work/)
-   [Warehouse mobile device display settings](http://ax.help.dynamics.com/en/wiki/changing-the-look-and-feel-of-warehouse-mobile-device-displays/)
...
-   [Cycle counting](http://ax.help.dynamics.com/en/wiki/cycle-counting/)
-   [Define cycle counting](http://ax.help.dynamics.com/en/wiki/define-cycle-counting/)
-   [Replenishment](http://ax.help.dynamics.com/en/wiki/replenishment/)
...
-   [Warehouse Mobile Devices Portal for Microsoft Dynamics 365 for Operations](http://ax.help.dynamics.com/en/wiki/warehouse-mobile-devices-portal-for-microsoft-dynamics-ax/)
