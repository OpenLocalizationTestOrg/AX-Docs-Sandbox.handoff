...
# ms.tgt_pltfrm: 
ms.custom: 92303
ms.assetid: f36cbcf6-64ad-4b8e-a4a5-e767b6d899c7
# ms.region: 
# ms.industry: 
ms.author: annbe
...
## Sales
You use the sales functionality to create quotations, up-sell and cross-sell to new and existing customers, create sales orders, and create sales invoices for customers. The following process flow shows the business process for sales. ![Business process for sales]
