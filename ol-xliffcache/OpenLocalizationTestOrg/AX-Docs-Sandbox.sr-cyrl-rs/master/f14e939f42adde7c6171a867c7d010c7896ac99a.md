...
title: Recalculating replacement costs and insured values for fixed asset groups | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 3261
ms.assetid: 6402aea3-88b5-459d-b6e2-aba753ca9567
# ms.region: 
# ms.industry: 
ms.author: twheeloc
...
# Recalculating replacement costs and insured values for fixed asset groups
