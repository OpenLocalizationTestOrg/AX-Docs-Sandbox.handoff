...
# ms.tgt_pltfrm: 
ms.custom: 220864
ms.assetid: cee948c0-430f-4a74-a6ba-886e8b1acb88
ms.region: USA
# ms.industry: 
ms.author: rschloma
...
## Next step
After you generate earnings, you must release them before you can create pay statements. You might also have to change the earnings or put certain earnings on hold. For more information, see [Work with existing earnings](http://ax.help.dynamics.com/en/wiki/work-with-existing-earnings/).
