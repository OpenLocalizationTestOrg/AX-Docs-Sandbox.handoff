...
title: Copy a configuration (Lifecycle Services, LCS) | Microsoft Docs
description: 
author: annbe
manager: AnnBe
...
# ms.tgt_pltfrm: 
ms.custom: 15541
ms.assetid: 358ac30d-0794-4209-9e57-5968501fe354
# ms.region: 
# ms.industry: 
ms.author: annbe
...
Before you begin, you must set up Configuration manager (beta). For more information, see [Set up Configuration manager (Lifecycle Services, LCS)](http://ax.help.dynamics.com/en/wiki/set-up-configuration-manager-lifecycle-services-lcs/).
