...
# ms.tgt_pltfrm: 
ms.custom: 50691
ms.assetid: 1fcac75d-ac68-42d5-abd0-95652365f288
# ms.region: 
...
-   [Transport management engines](http://ax.help.dynamics.com/en/wiki/transportation-management-engines/)
-   [Create a new transportation management engine](http://ax.help.dynamics.com/en/wiki/create-a-new-transportation-management-engine/)
...
-   [Planning freight transportation routes with multiple stops](http://ax.help.dynamics.com/en/wiki/planning-freight-transportation-routes-with-multiple-stops/)
-   [Create a bill of lading](http://ax.help.dynamics.com/en/wiki/create-a-bill-of-lading/)
...
-   [Reconcile freight in transportation management](http://ax.help.dynamics.com/en/wiki/reconcile-freight-in-transportation-management/)
...
-   [Plan loads using hub consolidation](http://ax.help.dynamics.com/en/wiki/plan-loads-using-hub-consolidation/)
