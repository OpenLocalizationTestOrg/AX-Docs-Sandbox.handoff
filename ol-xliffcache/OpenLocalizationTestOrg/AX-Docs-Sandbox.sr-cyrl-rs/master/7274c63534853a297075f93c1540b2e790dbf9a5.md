...
title: CLI106: Building a workspace | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 10794
ms.assetid: f97ba1cd-c80d-43a6-a55e-7d0f5a271acf
# ms.region: 
# ms.industry: 
ms.author: jasongre
...
4.  Click **PanoramaBody**. ![Operational workspace pattern]
...
## Related tutorials
-   [Building the Customer form](https://ax.help.dynamics.com/en/wiki/cli102-building-the-customer-form/) – See this tutorial if you want more exposure to form patterns. This tutorial will walk through the process of applying the Details Master pattern to a form.
-   [Building navigation](http://ax.help.dynamics.com/en/wiki/building-navigation/) – See this tutorial if you want instructions for adding your workspace to the Dynamics AX menu structure.
