...
title: Scenario: Use one customer payment to settle multiple invoices that span multiple discount periods | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 14511
ms.assetid: 3a6b25d7-0c80-4f62-86ea-8626bff271be
# ms.region: 
# ms.industry: 
ms.author: twheeloc
