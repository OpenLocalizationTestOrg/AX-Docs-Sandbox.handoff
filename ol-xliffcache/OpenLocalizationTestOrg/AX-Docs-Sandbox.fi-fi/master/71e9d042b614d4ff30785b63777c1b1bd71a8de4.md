...
title: Copy data between Microsoft Dynamics AX instances (DIXF) (AX 2012) | Microsoft Docs
description: 
author: annbe
manager: AnnBe
...
# ms.tgt_pltfrm: 
ms.custom: 20251
ms.assetid: 686333c9-2b8e-4d97-b023-b84ddd181dd8
# ms.region: 
# ms.industry: 
ms.author: annbe
...
# Copy data between Microsoft Dynamics AX instances (DIXF) (AX 2012)
...
The following diagram illustrates the path that data takes during the export and import processes. ![WalkthroughCopyDataBetweenAXInstances1]
