...
title: Patching SQL Server Reporting Services in a one-box environment | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 23661
ms.assetid: a88809a1-a431-4dcf-98eb-83cb1e6967c0
# ms.region: 
# ms.industry: 
ms.author: RobinARH
...
# Patching SQL Server Reporting Services in a one-box environment
