...
title: Migrate data using the Data import/export framework (DIXF) (AX 2012) | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 13341
ms.assetid: 4a22ee1e-c63c-4771-9562-dc152c0056b9
# ms.region: 
# ms.industry: 
ms.author: annbe
...
# Migrate data using the Data import/export framework (DIXF) (AX 2012)
