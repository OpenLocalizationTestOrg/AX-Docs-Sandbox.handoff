...
title: Copy a Microsoft Dynamics 365 for Operations database from Azure SQL Database to a SQL Server environment | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 203764
ms.assetid: 434fb3aa-6a72-4f9f-9527-f7229babafed
# ms.region: 
# ms.industry: 
ms.author: MargoC
...
When you attempt to download the SQL Management Studio install, you might receive the following error. ![SecuritySettingsCannotDownload]         To work around this issue, enable file download for the **Internet Zone**, on the **Security** tab in **Internet Options** as shown below. ![SecuritySettingsFix]
