...
title: Business process modeler libraries (LCS Solutions) | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 196953
ms.assetid: 17f2edd2-9910-48d7-8360-962884076b23
# ms.region: 
# ms.industry: 
ms.author: kfend
...
# Business process modeler libraries (LCS Solutions)
...
Task recordings should be created in a Microsoft Dynamics 365 for Operations environment that has your custom data and customizations. For reference information about Task recorder, see [Task Recorder in Microsoft Dynamics 365 for Operations](http://ax.help.dynamics.com/en/wiki/task-recorder-in-ax7/).
