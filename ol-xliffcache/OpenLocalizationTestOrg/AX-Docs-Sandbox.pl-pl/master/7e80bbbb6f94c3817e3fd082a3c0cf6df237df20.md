...
# ms.tgt_pltfrm: 
ms.custom: 18341
ms.assetid: 62de5302-28e6-44ed-b946-a13c72cb82e4
# ms.region: 
# ms.industry: 
ms.author: MargoC
...
4.  Use your AAD credentials to sign in. The AAD account must already be mapped. For instructions, see [Retail Modern POS self-service and device activation](https://ax.help.dynamics.com/en/wiki/retail-modern-pos-and-device-activation-scenarios/). For Cloud POS, the server URL is automatically entered in the address bar. For Modern POS, you must copy and paste the server URL.![p18]
5.  Click **Next** to populate the list of stores.
6.  Select the correct store in the list.![p20]
7.  Select the correct register and device. **Note:** The device can be **Pending**, **De-activated**, or **Activated**. Alternatively, if you turned on the Retail HQ **Allow devices to be associated to registers from store** setting, you might see a list of registers that have no device associated with them. ![p22]
8.  Click **Activate**. The device should be activated. ![p23]
