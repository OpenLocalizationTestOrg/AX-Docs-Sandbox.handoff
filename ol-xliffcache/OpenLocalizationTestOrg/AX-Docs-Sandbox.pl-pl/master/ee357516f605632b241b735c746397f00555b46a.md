...
title: Making manual adjustments to the baseline forecast | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 72704
ms.assetid: d022536c-37b4-4465-bf36-5cc1906f2235
ms.region: global
...
# Making manual adjustments to the baseline forecast
...
-   The internal model accuracy (MAPE). For more information about forecast accuracy, see [Monitoring forecast accuracy](http://ax.help.dynamics.com/en/wiki/monitoring-forecast-accuracy/).
