...
title: Copy data between Microsoft Dynamics AX companies (DIXF) (AX 2012) | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 17821
ms.assetid: 4e9c4e63-794d-4250-89eb-76d4b355c2ff
# ms.region: 
# ms.industry: 
ms.author: annbe
...
The following diagram illustrates the path that data takes during the export and import processes. ![WalkthroughCopyDataBetweenAXCompanies1]
