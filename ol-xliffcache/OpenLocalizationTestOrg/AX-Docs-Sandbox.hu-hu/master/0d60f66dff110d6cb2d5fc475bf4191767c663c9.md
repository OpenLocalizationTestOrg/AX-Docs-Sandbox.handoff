...
title: Deploy an AX 2012 R3 or AX 2012 R3 CU8 demo environment on Azure | Microsoft Docs
description: 
author: annbe
manager: AnnBe
...
# ms.tgt_pltfrm: 
ms.custom: 15561
ms.assetid: a538b21f-74f3-4f56-b097-812723d0795b
# ms.region: 
# ms.industry: 
ms.author: annbe
...
7.  One virtual machine will be deployed on Azure. The default size of this virtual machine is D3 (4 cores, 14 GB memory). If you want to change the size, select a different size from the **Size** list.
    ...
    -   For more information about the software installed on the virtual machine, see [Plan your Microsoft Dynamics AX 2012 R3 deployment on Azure](http://ax.help.dynamics.com/en/wiki/plan-your-microsoft-dynamics-ax-2012-r3-deployment-on-azure/).
