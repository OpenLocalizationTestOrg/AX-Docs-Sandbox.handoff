...
# ms.tgt_pltfrm: 
ms.custom: 24821
ms.assetid: e3184618-7464-47bc-9117-f253c2c12460
# ms.region: 
# ms.industry: 
ms.author: RobinARH
...
-   It supports several document formats, source mapping, Extensible Stylesheet Language Transformations (XSLT), and filters. ![image001](media/image001-1024x348.png)
-   It uses secure REST application programming interfaces (APIs) and authorization mechanisms to receive data from and send data back to integration systems. ![image003](media/image003-1024x431.png)
...
To get the activity ID, go to the manage recurring job view, and copy and paste the GUID (highlighted in the following screen shot). ![image015]
