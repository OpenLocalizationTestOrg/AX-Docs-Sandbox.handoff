...
# ms.tgt_pltfrm: 
ms.custom: 13261
ms.assetid: d5528336-51e8-4f05-bbb4-26e94c538f49
# ms.region: 
# ms.industry: 
ms.author: MargoC
...
2.  Install the Test Data Tool. For instructions, see [Install the Test Data Transfer Tool (beta) for Microsoft Dynamics AX](http://ax.help.dynamics.com/en/wiki/install-the-test-data-transfer-tool-beta-for-microsoft-dynamics-ax/).
