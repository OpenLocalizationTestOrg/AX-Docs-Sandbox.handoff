...
# ms.tgt_pltfrm: 
ms.custom: 202614
ms.assetid: 244255dc-9d4b-44e4-a0df-a75859eb1e08
# ms.region: 
# ms.industry: 
ms.author: RobinARH
...
-   When you need to overlayer code, do not include functional or business logic in the overlayered code. Instead, define and call a delegate method, then implement the logic in your extension model using an event handler. For a detailed example in the context of code migration, see [Delegates.](http://ax.help.dynamics.com/wiki/delegates-for-migration/)
-   Report commonly used over-layering patterns to Microsoft and request extension support.

For more information, see [Customizing with Extensions and Overlayering,](http://ax.help.dynamics.com/wiki/technical-concepts-guide/#customizing-with-extensions-and-overlayering) [Models](http://ax.help.dynamics.com/wiki/models), and the [Development Tools](https://ax.help.dynamics.com/wiki/technical-concepts-guide/#development-tools) section.

### How do I prevent my models from being customized by customers or other partners?

You can block customizations of your model as described in [How to disable model customization and deprecate functionality,](https://ax.help.dynamics.com/wiki/locking-models) or you can distribute deployable packages to your customers instead of distributing model files. See the section titled "How do I distribute my application to customers" later in this topic.
...
This is not supported. However, you can provision more than one developer account on the same VM, they just cannot develop concurrently. For details, see [Enable a new developer on a development machine](https://ax.help.dynamics.com/en/wiki/enable-a-new-developer-on-a-dynamics-ax-development-machine/).
