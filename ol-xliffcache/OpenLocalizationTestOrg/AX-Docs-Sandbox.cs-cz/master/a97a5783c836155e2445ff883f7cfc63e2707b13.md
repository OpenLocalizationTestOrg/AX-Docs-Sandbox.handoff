...
Adding this text as a test, need to check localizations tatus.xlsx file after I download ax-docs-sandbox ie replicate what LIOX would do for handoff This topic explains how to configure the properties for a manual task.
