...
title: Install the Data import/export framework (DIXF) (AX 2012) | Microsoft Docs
description: 
author: annbe
manager: AnnBe
...
# ms.tgt_pltfrm: 
ms.custom: 17631
ms.assetid: b3c255fb-6fe2-4521-af02-e2e7c6ff40e8
# ms.region: 
# ms.industry: 
ms.author: annbe
...
To install the version of the framework available in Microsoft Dynamics AX 2012 R3, follow the instructions in [Install the Data import/export framework (AX 2012 R3)](http://ax.help.dynamics.com/en/wiki/install-the-data-importexport-framework-ax-2012-r3/).
