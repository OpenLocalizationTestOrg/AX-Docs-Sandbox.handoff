...
# ms.tgt_pltfrm: 
ms.custom: 27461
ms.assetid: 2dce8679-9350-4376-9377-15b48cb865da
# ms.region: 
# ms.industry: 
ms.author: RobinARH
...
The following diagram shows the artifacts that are involved and their relation to each other. ![Control extensibility architecture]
