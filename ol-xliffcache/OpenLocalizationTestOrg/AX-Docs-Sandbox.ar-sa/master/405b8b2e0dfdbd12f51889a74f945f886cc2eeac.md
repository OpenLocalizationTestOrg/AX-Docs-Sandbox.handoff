...
title: Access Microsoft Dynamics 365 for Operations instances | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 10031
ms.assetid: cb6cb337-8752-471e-bb5d-c01c26282647
# ms.region: 
# ms.industry: 
ms.author: RobinARH
...
3.  Query Azure AD for your tenant and user ID. Open a Windows PowerShell Integrated Scripting Environment (ISE) window with administrative privileges, and run the following command. You will be prompted for Azure AD credentials. Use the same user account that you used in the admin user provisioning tool earlier.
    ...
    ![Command in the Windows PowerShell ISE window](media/RetailConfig02-1024x529.png)
...
-   [Microsoft Dynamics 365 for Operations – Retail for IT Pros and developers](https://ax.help.dynamics.com/en/wiki/microsoft-dynamics-ax-retail-for-it-pros-and-developers/)
-   [Retail SDK overview](https://ax.help.dynamics.com/en/wiki/retail-sdk-overview/)
