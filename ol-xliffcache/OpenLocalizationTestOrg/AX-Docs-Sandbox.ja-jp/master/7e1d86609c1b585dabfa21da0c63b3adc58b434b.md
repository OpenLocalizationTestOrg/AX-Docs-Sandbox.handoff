...
title: Configure the version of SQL Server Integration Services used by the Data import/export framework in an environment with multiple versions (DIXF) | Microsoft Docs
description: 
author: annbe
manager: AnnBe
...
# ms.tgt_pltfrm: 
ms.custom: 51562
ms.assetid: 0513a384-1f73-4b0b-a8e2-8412be964f72
# ms.region: 
# ms.industry: 
ms.author: annbe
