...
title: Request a point-in-time restore on a non-production environment | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 257614
ms.assetid: 580a0aee-fe2d-4e43-92b0-ab3e44384a15
# ms.region: 
# ms.industry: 
ms.author: MargoC
...
# Request a point-in-time restore on a non-production environment
...
1.  Click the hamburger icon in the upper left of the Microsoft Dynamics Lifecycle Services (LCS) window, and then select **Work items** in the list. ![Work items]
